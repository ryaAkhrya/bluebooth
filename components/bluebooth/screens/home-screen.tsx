...
import { ResultHistoryModal } from '@/components/bluebooth/results/result-history-modal'
  ...
  return (
    <main className="bb-home bb-screen">
      <section className="bb-home-copy">
        ...
        <button className="bb-previous-button" onClick={() => setOpen(true)}><ImageIcon /> Result history</button>
      </section>
      <div className="bb-home-preview" aria-hidden="true">
        <div className="bb-mini-strip"><i /><i /><i /><i /><span>Room · Bluebooth</span></div>
      </div>
      <ResultHistoryModal open={open} onClose={() => setOpen(false)} />
    </main>
  )
}
